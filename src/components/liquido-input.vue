    ...
    >
      ...
      >
        <path
          ...
          stroke-linejoin="round"
          stroke-width="2"
          d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.956 9.956 0 012.293-3.95M6.62 6.62A9.956 9.956 0 0112 5c4.478 0 8.268 2.943 9.542 7a9.956 9.956 0 01-4.293 5.95M15 12a3 3 0 11-6 0 3 3 0 016 0z"
        />
        <path
          stroke-linecap="round"
          stroke-linejoin="round"
...
export default {
  ...
  computed: {
    ...
    showEmptyFeedback() {
      return (
        this.state === STATE.INVALID && this.emptyFeedback && !this.modelValue
      );
    },
  ...
  methods: {
    ...
    defaultValidFunc(val) {
      ...
      switch (this.type.toLowerCase()) {
        ...
        case 'mobilephone':
          return this.isValidMobilephone(val);
        case 'number':
          return !isNaN(val);
        case 'integer':
    ...
    keydown(evt) {
      if (
        (this.type === 'number' || this.type === 'integer') &&
        /[0-9]/.test(evt.key) &&
        this.modelValue &&
